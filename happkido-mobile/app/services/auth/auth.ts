...
export class AuthService {
  ...
  auth0 = new Auth0({clientID: 'UPbFPoLM2ooXIR8g9jrHPME6UvCJKaIJ', domain: 'rapelt.au.auth0.com'});
  lock = new Auth0Lock('UPbFPoLM2ooXIR8g9jrHPME6UvCJKaIJ', 'rapelt.au.auth0.com', {
    auth: {
      redirect: false,
      params: {
